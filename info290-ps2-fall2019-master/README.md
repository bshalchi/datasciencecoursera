...
- This document should be created by a `.ipynb` file that we can execute that produces all answers, without error. But, you shouldn't submit your .ipynb, onlyl the `.md`. 
...
To create the `.md` version of your solutions, please use [jupytext](https://jupytext.readthedocs.io/en/latest/). This will let you keep a version of your notebook, and a markdown file in sync. It will also let me provide line-by-line comments your PR in a way that is not possible with a whole jupyter notebook. 

After installing jupytext, select to pair the notebook with markdown. 
